  ...
  return (
    <section className="page-section mb-5">
      <div className="app-card overflow-hidden border-app-gold/25 bg-gradient-to-br from-[#2a1810]/35 via-app-card to-app-bg/80 !p-0">
        <div className="flex items-center gap-2 border-b border-app-border/60 px-4 py-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-app-gold/15">
        ...
        <div className="space-y-3 px-4 py-3">
          <div className="rounded-xl border border-app-gold/20 bg-app-bg/50 px-3 py-2 text-center">
            <p className="text-sm font-medium text-app-text">{huangli.lunarDate}</p>
            <p className="mt-0.5 text-[11px] text-app-muted">{huangli.dayGanZhi}</p>
          </div>
